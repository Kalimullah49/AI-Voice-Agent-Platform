...
// Hardcoded due to Replit environment variable caching issue
const ELEVENLABS_API_KEY = 'sk_4abf57e070f576a328eb0012846ecea19777e695069c844c';
...
console.log('🔊 Environment variable raw:', process.env.ELEVENLABS_API_KEY ? process.env.ELEVENLABS_API_KEY.substring(0, 12) + '...' : 'NOT FOUND');
