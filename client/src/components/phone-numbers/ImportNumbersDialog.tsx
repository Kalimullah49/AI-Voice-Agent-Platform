...
interface ImportNumbersDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  twilioAccounts: any[];
}

export function ImportNumbersDialog({ open, onOpenChange, twilioAccounts }: ImportNumbersDialogProps) {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            numbers that are not already managed by AimAI.
          </DialogDescription>
        </DialogHeader>
